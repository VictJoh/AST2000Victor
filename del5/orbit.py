...
def interpolate(times, positions_over_time, planet_idx, t, velocities_over_time = None):
    """
    Interpolates the position (and optionally velocity) at a given time
...
def main():
    ...
    t_launch =  # 4.250001 #yrs brute forced as I can't use Hohmann launch time because of angle = 0 and the boost dv0 :( 
    ...
    simulation_time = 5 # Total simulation time in years
